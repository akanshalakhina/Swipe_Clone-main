...
const typingWords = ['Invoicing', 'Billing', 'Accounting', 'Inventory', 'Payments']
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-1.5 bg-blue-50 text-blue-600 text-sm font-medium rounded-full mb-6 border border-blue-100"
            >
              <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
              Trusted by 20,00,000+ businesses
            </motion.div>

            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-[56px] font-extrabold text-gray-900 leading-tight mb-6">
              Simple{' '}
              <span className="">
                {text}
            ...
            <p className="text-base sm:text-lg text-gray-500 leading-relaxed mb-8 max-w-lg">
              Create GST invoices, manage inventory, track payments, and grow your business - all from one simple app. Free forever.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-8">
              ...
              <Button as="motion" variant="secondary" size="lg" icon={Play} iconPosition="left">
                Watch demo
              </Button>
            </div>
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <div className="flex gap-2">
                <a href="#" className="h-9 px-3 bg-gray-900 text-white rounded-lg flex items-center gap-1.5 text-xs font-medium hover:bg-gray-800 transition-colors">
